    ...
    for (j = 0; j < len; ++j) {
      ...
      if (!get(code1, code2)) {
        if (proj42.defs[code1] === proj42.defs[code2]) {
          ...
          var transform3 = proj42(code1, code2);
...
var CanvasImageLayerRenderer = function(_super) {
  ...
  CanvasImageLayerRenderer2.prototype.renderFrame = function(frameState, target) {
    ...
    var transform3 = compose(this.tempTransform, width / 2, height / 2, scale2, scale2, 0, imagePixelRatio * (imageExtent[0] - viewCenter[0]) / imageResolution, imagePixelRatio * (viewCenter[1] - imageExtent[3]) / imageResolution);
    this.renderedResolution = imageResolution * pixelRatio / imagePixelRatio;
    var dw = img.width * transform3[0];
    var dh = img.height * transform3[3];
...
var BaseTileLayer = function(_super) {
  __extends4(BaseTileLayer2, _super);
...
var ReprojImage = function(_super) {
  __extends10(ReprojImage2, _super);
...
var ImageSourceEvent = function(_super) {
  __extends11(ImageSourceEvent2, _super);
...
var ImageSource = function(_super) {
  __extends11(ImageSource2, _super);
...
var ImageWMS = function(_super) {
  ...
  ImageWMS2.prototype.getFeatureInfoUrl = function(coordinate, resolution, projection, params2) {
    ...
    var projectionObj = get2(projection);
  ...
  ImageWMS2.prototype.getRequestUrl_ = function(extent, size, pixelRatio, projection, params2) {
...
function createXYZ(opt_options) {
  ...
  var extent = xyzOptions.extent || get2("EPSG:3857").getExtent();
  var gridOptions = {
    extent,
...
function synchronizeTileWMSSource(target, source, context) {
  if (!target) {
    target = new TileWMS_default(createOptions(source));
  }
...
function synchronizeXYZSource(target, source, context) {
  if (!target) {
    target = new XYZ_default(createOptions(source));
  }
  synchronizeTileImageSource(target, source, context);
  return target;
}
function synchronizeOSMSource(target, source, context) {
  if (!target) {
    target = new OSM_default(createOptions(source));
  }
  if (!source.attributions) {
    source.attributions = ATTRIBUTION;
  }
...
function synchronizeImageWMSSource(target, source, context) {
  if (!target) {
    target = new ImageWMS_default(createOptions(source));
  }
...
function synchronizePoint(target, source, _context) {
  if (!target) {
    target = new Point_default(convertToCoordinateArray(source.coordinates));
  }
...
function getLayerForFeature(layers, feature) {
  return layers.find((layer) => {
    ...
    const isVectorSource = source && source instanceof Vector_default2;
...
(function() {
  ...
  function setUserProjection2(projection) {
  ...
  window.Vaadin.Flow.mapConnector = {
    init: init33,
    setUserProjection: setUserProjection2,
    defineProjection
  };
})();
/**
