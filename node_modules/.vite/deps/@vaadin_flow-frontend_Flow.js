import {
  ConnectionIndicator,
  ConnectionState
} from "./chunk-IZLL7OVI.js";
import "./chunk-J6QRQFHX.js";
import "./chunk-JYAXTGHO.js";
import "./chunk-SHSGZHRG.js";
...
var Flow = class {
  ...
  async flowInit(serverSideRouting = false) {
    if (!this.isFlowClientLoaded()) {
      ...
      const bootstrapMod = await import("./FlowBootstrap-MIP6M3Y2.js");
      await bootstrapMod.init(this.response);
      if (typeof this.config.imports === "function") {
        this.injectAppIdScript(appId);
        await this.config.imports();
      }
      const clientMod = await import("./FlowClient-7XPXQWRU.js");
